...
contract BusinessLicenses {
    ...
    function storeLicense(address _businessAddress, string memory _fileLink, string memory _businessName, uint256 _issueDate) public payable {
    ...
    function registerSupervisor(address _supervisorAddress, string memory _name, string memory _email, string memory _phone) public payable {
